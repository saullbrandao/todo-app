...
export function List() {
  ...
  return (
    <ul className="flex flex-col items-center bg-white dark:bg-dark-blue-800 rounded-md w-full -mt-8 divide-y divide-[#eae9ed] dark:divide-dark-gray-400 shadow-sm">
